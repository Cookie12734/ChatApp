    ...
    >
      ...
      <div className="flex min-w-0 flex-wrap items-end gap-2">
        <label
          ...
          className={cn(
            "border-connect-ink/50 bg-connect-paper flex min-h-11 shrink-0 items-center justify-center gap-2 rounded-md border px-3 text-sm font-semibold whitespace-nowrap",
            controlsDisabled
        ...
        <div className="min-w-0 basis-full sm:flex-1 sm:basis-auto">
          ...
          <div className="flex min-w-0 gap-2">
            ...
            <input
              ...
              className={cn(
                "border-connect-ink/50 bg-connect-paper placeholder:text-connect-muted enabled:hover:bg-connect-highlight min-h-11 min-w-0 flex-1 rounded-md border px-3 text-base disabled:cursor-not-allowed disabled:opacity-50",
